...
class User:
    ...
    def request_friend(self, uid):
        ...
        if other_user.notify_new_friend_req:
            ...
            notifs.send_notification_to_user("New Friend Request", self.firstname + " " + self.lastname + " has requested your friendship", uid, data={"uid": self.uid})
    ...
    def accept_friend(self, uid):
        ...
        try:
            ...
            if other_user.notify_new_friend_acc:
                notifs = Notifications(self.host, self.username, self.password, self.database)
                notifs.send_notification_to_user("Friendship Accepted!", self.firstname + " " + self.lastname + " has accepted your friendship!", uid, data={"uid": self.uid})
        except:
            pass
